    ...
    <body>
        ...
        <%
           ...
           String[] data = new String[]{
                ...
                "INSERT INTO " + schema + ".CUSTOMER (id, credentials, dataCreacio, description, profilePhoto) VALUES (NEXT VALUE FOR CUSTOMER_GEN, (SELECT MAX(id) FROM " + schema + ".CREDENTIALS), '2024-11-22', 'Hola breu descripció', 'C:\\Users\\Kevin\\fotoPerfil.png')",
